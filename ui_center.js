...
function viewButtonX() {
  return menuX() + 10;
}

function viewButtonY() {
  return menuY() + 8;
}

function viewButtonW() {
  return menuW() - 20;
}

function viewButtonH() {
  return 30;
}
